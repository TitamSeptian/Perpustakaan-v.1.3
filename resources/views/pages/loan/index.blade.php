	...
	$(document).ready(function() {
    	$('#example').DataTable({
            ...
            "columns": [
                ...
                {"data" : "tanggal_kembali", "render": function (ntgl, a, b) {
                    // console.info(ntgl);
                    ...
                    let kmbl = ntgl;
                     var hTelat = selisih_tanggal(kmbl);
                ...
                {"data": "id", 'render': function (id,a,b,c,d) {
                    return `
                        <a href="/loan/detail/${id}" class="btn btn-sm btn-outline-info"> Lihat</a>
                        <a href="/loan/edit/${id}" class="btn btn-sm btn-outline-warning"> Edit</a>
                        <a href="/kembalikan/${id}" class="btn btn-sm btn-outline-primary"> Kembalikan</a>
                    `;
                }}
            ]
        });
